            ...
            builder: (BuildContext context, Widget child) {
              double bottomInset = widget.route.resizeToAvoidBottomPadding
                  ? ((MediaQuery.of(context).viewInsets.bottom == 0.0)
                      ...
                      : MediaQuery.of(context).viewInsets.bottom - widget.route.bottomInset)
                  : 0.0;
              return new ClipRect(
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  @override
  Color get barrierColor => barrierCustomColor;
...
Future<T> showModalBottomSheetApp<T>({
  ...
  Color barrierColor: Colors.white54,
  double bottomInset: 0.0,
}) {
  assert(context != null);
  assert(builder != null);
  return Navigator.push(
      ...
      new _ModalBottomSheetRoute<T>(
        ...
        barrierCustomColor: barrierColor,
