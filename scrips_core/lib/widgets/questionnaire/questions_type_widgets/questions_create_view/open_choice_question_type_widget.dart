...
class OpenChoiceQuestionTypeWidget extends StatefulWidget {
  OpenChoiceQuestionTypeWidget(
      {Key key,
  ...
  @override
  _OpenChoiceQuestionTypeWidgetState createState() =>
      _OpenChoiceQuestionTypeWidgetState();
}

class _OpenChoiceQuestionTypeWidgetState
    extends State<OpenChoiceQuestionTypeWidget> {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            PatientFacingInfoWidget(
              text: "Patient facing option search",
            ),
            Space(
              vertical: 24,
            ),
