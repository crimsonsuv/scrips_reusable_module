...
class StringQuestionTypeWidget extends StatefulWidget {
  StringQuestionTypeWidget(
      {Key key,
  ...
  @override
  _StringQuestionTypeWidgetState createState() =>
      _StringQuestionTypeWidgetState();
}

class _StringQuestionTypeWidgetState extends State<StringQuestionTypeWidget> {
        ...
        child: Column(
          children: <Widget>[
            ...
            PatientFacingInfoWidget(
              text: "Patient facing single line text field",
            ),
            Space(
              vertical: 24,
            ),
