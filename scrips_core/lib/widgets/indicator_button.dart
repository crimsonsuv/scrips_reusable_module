        ...
        child: Container(
          ...
          child: Stack(children: [
            Container(
                ...
                decoration:
                    BoxDecoration(borderRadius: BorderRadius.circular(10.0), color: primaryColor),
                child: PlatformText(
                  title,
            ...
            hasIndication
                ? Positioned(
                    ...
                    child: Container(
                      ...
                      height: 30,
                      alignment: Alignment.center,
                      decoration: ShapeDecoration(shape: CircleBorder(), color: darkGrey),
                      child: PlatformText(indicationCount.toString(),
