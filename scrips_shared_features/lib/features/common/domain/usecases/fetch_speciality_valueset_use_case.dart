...
class FetchSpecialityCodeUseCase extends UseCase<List<CodeList>, QueryParams> {
  CommonRepository repository;

  FetchSpecialityCodeUseCase({@required this.repository});

  @override
  Future<Either<Failure, List<CodeList>>> call(QueryParams params) {
    return repository.practiceCodeList(params.query);
  }
}
