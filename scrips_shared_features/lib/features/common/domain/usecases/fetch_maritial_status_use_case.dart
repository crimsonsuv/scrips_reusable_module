...
class FetchMaritialStatusUseCase
    extends UseCase<List<MaritalStatus>, NoParams> {
  CommonRepository repository;

  FetchMaritialStatusUseCase({@required this.repository});

  @override
  Future<Either<Failure, List<MaritalStatus>>> call(NoParams params) {
    return repository.maritialList();
  }
}
